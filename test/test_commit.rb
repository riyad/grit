...
class TestCommit < Test::Unit::TestCase
  ...
  def test_diff
    ...
    assert_equal '4ebc8aea50e0a67e000ba29a30809d0a7b9b2666', diffs.first.a_sha
    assert_equal '2dd02534615434d88c51307beb0f0092f21fd103', diffs.first.b_sha
    ...
    assert_equal nil, diffs[5].a_sha
    assert_equal 'f733bce6b57c0e5e353206e692b0e3105c2527f4', diffs[5].b_sha
  ...
  def test_diffs_on_initial_import
    ...
    assert_equal '81d2c27608b352814cbe979a6acd678d30219678', diffs.first.b_sha
    ...
    assert_equal '32cec87d1e78946a827ddf6a8776be4d81dcf1d1', diffs[5].b_sha
    assert_equal true, diffs[5].new_file
  end
